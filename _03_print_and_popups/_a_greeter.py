...
if __name__ == '__main__':
    ...
    Nikhil = simpledialog.askstring(title='Greeter', prompt="What is your name?")
    # Show a message box with your message using the .showinfo() method
    messagebox.showinfo(title='Greeting', message="I'm Good")
    # Print your message to the console using the print() function
    print("la la la")
    # Show an error message using messagebox.showerror()
    messagebox.showerror(title="nicky", message="show error")
