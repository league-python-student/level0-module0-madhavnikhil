...
if __name__ == '__main__':
    ...
    messagebox.showinfo(title=window, message="If you find yourself having to cross a pirahna-infested river, here's how to do it")
    # "If you find yourself having to cross a piranha-infested river, here's how to do it..."

    # Get the player to enter an adjective
    Adjective = simpledialog.askstring(title=window, prompt="Enter an Adjective")
    # Get the player to enter a type of liquid
    Liquid = simpledialog.askstring(title=window, prompt="Enter a type of liquid.")
    # Get the player to enter a body part
    BodyPart = simpledialog.askstring(title=window, prompt="Enter a body part.")
    # Get the player to enter a verb
    Verb = simpledialog.askstring(title=window, prompt="Enter a verb.")
    # Get the player to enter a place
    Place = simpledialog.askstring(title=window, prompt="Enter a place.")
    ...
    messagebox.showinfo(title=window, message=story)
